...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  const userHasFont = useMemo(() => Boolean(className && /font[-[]/i.test(className)), [className]);
  ...
  return React.createElement(Tag, { ref: ref as never, className: classes, style: commonStyle }, text);
};
